...
set_pwm_limit:
    ...
    jnb  Flag_Initial_Run_Phase, set_pwm_limit_comm_period_H_check ; More protection for initial run phase
    mov  A, #127

set_pwm_limit_comm_period_H_check:
...
set_pwm_limit_check_max:
    jz   set_pwm_limit_check_min                          ; Limit to max
    mov  Temp1, #0FFh

set_pwm_limit_check_min:
    clr  C
...
set_pwm_limit_high_rpm_store:
    jz   set_pwm_limit_high_exit
    mov  Pwm_Limit_By_Rpm, A

set_pwm_limit_high_exit:
    ret
